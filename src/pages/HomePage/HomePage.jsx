...
const HomePage = (props) => {
  ...
  return (
    <div className="homepage-container">
      <h1>quiet time</h1>
      <div>
        <Tooltip title="quiet time is an app focused to get you in the right mindset for growth. We provide an environment for you to let go of the otherworldly distractions through breathing exercises. This will put you in a place to focus on an idea. At this point, we share with you a meaningful quote from a thought leader. The end goal is provide you a space and opportunity to be introspective." placement="top">
          <InfoIcon />
        </Tooltip>
      </div>
      {home}
